...
export const UPDATE_TIMED_NEW_GAME = 'MainMenu/UPDATE_TIMED_NEW_GAME';
export const UPDATE_TIME_LIMIT_NEW_GAME = 'MainMenu/UPDATE_TIME_LIMIT_NEW_GAME';
...
export const updateTimedNewGame = makeActionCreator(UPDATE_TIMED_NEW_GAME, 'timed');
export const updateTimeLimitNewGame = makeActionCreator(UPDATE_TIME_LIMIT_NEW_GAME, 'time');
